...
import static GameRunner.BombermanGame.player;
import static Control.Menu.bomb_number;

public class Bomb extends Entity {
    private static long time_bomb;      // Exploding time bomb 
    private static long time_tmp;       // Time between 2 bomb placements
    private static Entity bomb;         
    private static int swap_active = 1;     // Change the operational state of the bomb
    private static int swap_explosion = 1;  // Change the bomb's explosive state
    ...
    private static int power_bomb_down = 0;     // Bomb's destructive power downwards
    private static int power_bomb_up = 0;       // Bomb's destructive power upwards
    private static int power_bomb_left = 0;     // Bomb's destructive power to the left
    private static int power_bomb_right = 0;    // Bomb's destructive power to the right
