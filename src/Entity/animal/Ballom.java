...
import static GameRunner.BombermanGame.enemy;
import static GameRunner.BombermanGame.list_kill;

public class Ballom extends Animal {
    private static int swap_kill = 1;
    private static int count_kill = 0;  // The number of Ballom killed.
